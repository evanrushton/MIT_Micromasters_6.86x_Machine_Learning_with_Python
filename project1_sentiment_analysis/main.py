...
T = 25
L = 0.01
(theta, theta_0) = p1.pegasos(train_bow_features, train_labels, T, L) # train on train data
preds = p1.classify(test_bow_features, theta, theta_0) # test on test data
test_accuracy = p1.accuracy(preds, test_labels) 
print("Testing accuracy for Pegasos: ", test_accuracy)
